...
namespace Frida {
	...
	public class Session : GLib.Object {
		...
		public async Frida.Script create_script (string source, Frida.ScriptOptions? options = null) throws Frida.Error;
		public Frida.Script create_script_sync (string source, Frida.ScriptOptions? options = null) throws Frida.Error;
		public async Frida.Script create_script_from_bytes (GLib.Bytes bytes, Frida.ScriptOptions? options = null) throws Frida.Error;
		public Frida.Script create_script_from_bytes_sync (GLib.Bytes bytes, Frida.ScriptOptions? options = null) throws Frida.Error;
		public async GLib.Bytes compile_script (string source, Frida.ScriptOptions? options = null) throws Frida.Error;
		public GLib.Bytes compile_script_sync (string source, Frida.ScriptOptions? options = null) throws Frida.Error;
	...
	public class Script : GLib.Object {
		...
		public async void eternalize () throws Frida.Error;
		public void eternalize_sync () throws Frida.Error;
